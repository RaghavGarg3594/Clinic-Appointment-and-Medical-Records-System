...
const DoctorPrescriptions = () => {
  ...
  // Build unique patient list for the quick-stat
  ...
  return (
    <Layout>
      <h1 className="text-2xl font-bold tracking-tight mb-6">Patient Prescriptions</h1>

      {/* Summary stat cards */}
      <motion.div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6" variants={container} initial="hidden" animate="show">
        {[
